...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> add(RequestCreationDto dto, long userId) {
    ...
    public ResponseEntity<Object> getAllFromOtherUsers(long userId, Integer from, Integer size) {
